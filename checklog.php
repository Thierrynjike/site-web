  ...
  <section class="menu cid-qTkzRZLJNu" once="menu" id="menu1-3">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-white-outline display-4" href="checklog.php">Try it Now!</a></div>
        </div>
    </nav>
</section>
<br><br><br>
...
<div id="mesdiv" class="col-sm-12 col-md-8 col-lg-6">
	<style>
		height:250px;
	...
	<br><br><br>
	<form id="mesure" method="POST" action="check.php">
		<label>ENTREZ VOS DONNÉES SVP</label>
		<br><br>
		<label>Sexe: </label>
		 <select id="sexe" name="sex" width="35px">
			<option value="Male">Male</option>
			<option value="Female">Female</option>
		</select> <br><br>
		<label>Taille: </label>
		<input type="text" name="height" placeholder="entez votre taille svp" required><br><br>
		<label>Poids: </label>
		<input type="text" name="weight" placeholder="entrez votre poids svp" required>
		<br><br>
		<input type="submit" name="submit" class="btn btn-primary" value="Try Now !">
	</form>
...
<section class="cid-rVW00Ypj45 mbr-reveal" id="footer1-k" style="background-color:#000">
