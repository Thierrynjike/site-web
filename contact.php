  ...
  <section class="menu cid-qTkzRZLJNu" once="menu" id="menu1-h">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-buttons mbr-section-btn"><a class="btn btn-sm btn-white-outline display-4" href="index.html">Try it Now!</a></div>
        </div>
    </nav>
</section>

<section class="engine"><a href="https://mobirise.info/p">site templates free download</a></section><section class="mbr-section form1 cid-rVVBN8CYJa" id="form1-i">
        ...
        <div class="row justify-content-center">
			...
			<br><br><br><br><br><br>
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5">
                    <p style="display: <?php echo($_COOKIE['disp']); ?>; color:green;" id="valider">Merci de votre message, Nous reviendrons vers vous au plus vite ! <p>
                </h3>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                <!---Formbuilder Form--->
                <form action="mailcontact.php" method="POST" class="mbr-form form-with-styler" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="a2rZ/UWGepPfqI4s70y854kVxzw3yl/4NaL9+FxtCO03ROJGNNy7CDtLmW71ZEcewL2mtKYitLVDUk5ukDaqHw5H/K0FuUO5O8VVoe4O8IOFZeQUOqVGNYC1MGacJFfu">
                    <div class="row">
                    ...
                    <div class="dragArea row">						
                        <div class="col-md-4  form-group" data-for="name">
                            ...
                            <input type="text" name="username" data-form-field="Name" required="required" class="form-control display-7" id="name-form1-i">
                        </div>
                        <div class="col-md-4  form-group" data-for="email">
                            <label for="email-form1-i" class="form-control-label mbr-fonts-style display-7">Email</label>
                            <input type="email" name="usermail" data-form-field="Email" required="required" class="form-control display-7" id="email-form1-i">
                        </div>
                        <div data-for="phone" class="col-md-4  form-group">
                            <label for="phone-form1-i" class="form-control-label mbr-fonts-style display-7">Phone</label>
                            <input type="tel" name="userphone" data-form-field="Phone" class="form-control display-7" id="phone-form1-i"placeholder="Facultatif">
                        </div>
                        ...
                        <div class="col-md-12 align-center"><button class="btn btn-primary display-4" onclick="validation()" >SUBMIT</button></div>
          ...
          <div class="media-container-row content text-white">
              ...
              <div class="col-12 col-md-3 mbr-fonts-style display-7">
                  ...
                  <p class="mbr-text"><strong>
                      Email</strong>: varchartry@gmail.com
                      <br><i class="fa fa-phone fa-1x sr-contact obj"></i>: +32 (0) 465 32 91 38&nbsp;<br></p>
              </div>
              <div class="col-12 col-md-3 mbr-fonts-style display-7">
                  <h5 class="pb-3"></h5>
